...
if(isset($_POST['logbtn']))
{
	...
	$run=mysqli_query($conn,"select * from users where name='".$name."' and pass='".$password."'");
...
<header role="banner">
  <div class="top-bar">
  	...
  	<div id="login_form" class="well log2 animated jackInTheBox">
		<h2 style="color: white;" class=" animated pulse infinite"><center><span class="fa fa-user"></span> Please Login</center></h2>
