...
if(isset($_POST['logbtn']))
{
	...
	$run=mysqli_query($conn,"update users set pass='$password' where name='$name'");
			if(isset($run))
				{
...
<header role="banner">
  <div class="top-bar">
  	...
  	<div id="login_form" class="well log2 animated jackInTheBox">
		<h2 style="color: white;" class=" animated pulse infinite"><center><span class="fa fa-user"></span> Reset Password</center></h2>
		...
		New Password <span class="fa fa-star"></span>: <input type="password" style="color: rgb(10,100,200);padding: 9px;border-color: white;" placeholder="enter your password" name="p" class="form-control" required> 
